...
class RaysArrayPart(WBPart):
    def __init__(
        ...
        r, g, b = wavelength2RGB(wavelenght / 1000.0)
    ...
    def propertyChanged(self, obj, prop):
        ...
        if prop == "wavelenght":
            r, g, b = wavelength2RGB(obj.wavelenght / 1000.0)
            obj.ViewObject.ShapeColor = (r, g, b, 0.0)
...
def InsertRArray(
    ...
    RaysArrayPart(
        myObj, Sx, Sy, Nx, Ny, nr, na, angle, distribution, wavelenght, enabled
    )
