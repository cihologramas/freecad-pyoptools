...
class ApertureGUI(WBCommandGUI):
    def __init__(self):
        ...
        WBCommandGUI.__init__(self,'Aperture.ui')
...
class AperturePart(WBPart):
    ...
    def pyoptools_repr(self,obj):
        ...
        return comp_lib.Stop(Circular(OutD/2.),Circular(InD/2.))
...
def buildaperture(InD,OutD):
    id=Part.makeCylinder(InD/2.,0.1)
    od=Part.makeCylinder(OutD/2.,0.1)
