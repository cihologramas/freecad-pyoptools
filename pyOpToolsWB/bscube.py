...
class BSCubeGUI(WBCommandGUI):
    def __init__(self):
        WBCommandGUI.__init__(self, 'BSCube.ui')
...
class BSCubeMenu(WBCommandMenu):
    ...
    def GetResources(self):
        return {"MenuText": "Beam Splitting Cube",
                #"Accel": "Ctrl+M",
...
class BSCubePart(WBPart):
    ...
    def pyoptools_repr(self,obj):
        ...
        rm=comp_lib.BeamSplitingCube(obj.S.Value,obj.Reflectivity/100.,material=material)
        return rm
